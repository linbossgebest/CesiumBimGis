...
namespace Cesium.IServices
{
    public interface IModelComponentService : IDependency
    {
        ...
        /// <returns></returns>
        Task<ResponseResult> AddModelComponentListAsync(List<Cesium.Models.ModelComponent> list);
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        Task<ResponseResult> AddModelComponentAsync(Cesium.Models.ModelComponent model);
        ...
        /// <returns></returns>
        Task<ResponseResult> UpdateModelComponentAsync(Cesium.Models.ModelComponent model);
        ...
        /// <returns></returns>
        Task<ResponseResult> DeleteModelComponent(string componentId);
